...
{
    /// <inheritdoc />
    public partial class Ver1Fix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOrder_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOrder_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOrder_ClientId",
                table: "ProductOrder",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOrder_EmployeeId",
                table: "ProductOrder",
                column: "EmployeeId");
